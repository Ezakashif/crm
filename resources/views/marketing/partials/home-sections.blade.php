@php
    $home = $home ?? config('marketing.home');
        ...
        <div class="hero-wrapper">
          ...
          <div class="hero-main-content text-center">
            ...
            <div class="hero-actions" data-aos="fade-up" data-aos-delay="400">
              <a href="{{ $trialHref }}" class="action-btn primary">
                <span>Start free trial</span>
                <i class="bi bi-arrow-right"></i>
              </a>
              <a href="{{ $demoHref }}" class="action-btn secondary">
            ...
            <div class="hero-image-showcase" data-aos="fade-up" data-aos-delay="500">
              <div class="image-wrapper">
                <img src="{{ asset('marketing/assets/img/about/about-18.webp') }}" class="img-fluid" alt="Strategic Overview">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row align-items-center justify-content-between g-lg-5">
          <div class="col-lg-6" data-aos="fade-right" data-aos-delay="200">
            <div class="image-wrapper">
              <img src="{{ asset('marketing/assets/img/about/about-portrait-7.webp') }}" class="img-fluid rounded" alt="About Us Image">
            </div>
          </div>
          ...
          <div class="col-lg-6" data-aos="fade-left" data-aos-delay="300">
            <div class="content">
              ...
              <div class="mt-5" data-aos="fade-up" data-aos-delay="600">
                <a href="{{ route('marketing.about') }}" class="btn btn-primary me-3">Learn More</a>
                <a href="{{ route('marketing.contact') }}" class="btn btn-outline-primary">Contact Us</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row align-items-center mb-5">
          ...
          <div class="col-lg-6" data-aos="fade-left" data-aos-delay="200">
            <div class="intro-image">
              <img src="{{ asset('marketing/assets/img/features/features-2.webp') }}" alt="Features" class="img-fluid">
            </div>
          </div>
        </div>
              ...
              <div class="row align-items-center">
                ...
                <div class="col-lg-5">
                  <div class="content-wrapper">
                    ...
                    <a href="{{ route('marketing.features') }}" class="btn-primary">Learn More <i class="bi bi-arrow-right"></i></a>
                  </div>
                </div>
                ...
                <div class="col-lg-7">
                  <div class="visual-content">
                    <div class="main-image">
                      <img src="{{ asset('marketing/assets/img/features/features-4.webp') }}" alt="" class="img-fluid">
            ...
            <div class="tab-pane fade" id="features-tabs-tab-2">
              <div class="row align-items-center">
                ...
                <div class="col-lg-7">
                  <div class="visual-content">
                    <div class="main-image">
                      <img src="{{ asset('marketing/assets/img/features/features-2.webp') }}" alt="" class="img-fluid">
                      <div class="floating-card">
                        <i class="bi bi-shield-check"></i>
                        <div class="card-content">
                          <span>Security</span>
            ...
            <div class="tab-pane fade" id="features-tabs-tab-3">
              <div class="row align-items-center">
                ...
                <div class="col-lg-7">
                  <div class="visual-content">
                    <div class="main-image">
                      <img src="{{ asset('marketing/assets/img/features/features-6.webp') }}" alt="" class="img-fluid">
                      <div class="floating-card">
            ...
            <div class="tab-pane fade" id="features-tabs-tab-4">
              <div class="row align-items-center">
                ...
                <div class="col-lg-7">
                  <div class="visual-content">
                    <div class="main-image">
                      <img src="{{ asset('marketing/assets/img/features/features-1.webp') }}" alt="" class="img-fluid">
                      <div class="floating-card">
        ...
        <div class="row align-items-center">
          <div class="col-lg-6">
            <div class="intro-content" data-aos="fade-right" data-aos-delay="100">
              ...
              <a href="{{ $trialHref }}" class="cta-button" data-aos="fade-right" data-aos-delay="200">
                Explore Our Work
              </a>
            </div>
          </div>
          <div class="col-lg-6">
            <div class="hero-visual" data-aos="fade-left" data-aos-delay="150">
              <img src="{{ asset('marketing/assets/img/services/services-1.webp') }}" alt="Services" class="img-fluid">
            </div>
          </div>
        </div>
        ...
        <div class="advertise-1 d-flex flex-column flex-lg-row gap-4 align-items-center position-relative">
          ...
          <div class="content-left flex-grow-1" data-aos="fade-right" data-aos-delay="200">
            ...
            <div class="cta-buttons d-flex flex-wrap gap-3">
              ...
              <a href="{{ route('marketing.features') }}" class="btn btn-outline">Learn More</a>
            </div>
          </div>

          <div class="content-right position-relative" data-aos="fade-left" data-aos-delay="300">
            <img src="{{ asset('marketing/assets/img/misc/misc-5.webp') }}" alt="Digital Platform" class="img-fluid rounded-4">
            <div class="floating-card">
              <div class="card-icon">
                <i class="bi bi-graph-up-arrow"></i>
              </div>
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item" data-aos="zoom-in" data-aos-delay="200">
                <div class="testimonial-header">
                  <img src="{{ asset('marketing/assets/img/person/person-f-12.webp') }}" alt="Client" class="img-fluid" loading="lazy">
                  <div class="rating">
                    <i class="bi bi-star-fill"></i>
                    <i class="bi bi-star-fill"></i>
                    <i class="bi bi-star-fill"></i>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item" data-aos="zoom-in" data-aos-delay="300">
                <div class="testimonial-header">
                  <img src="{{ asset('marketing/assets/img/person/person-m-8.webp') }}" alt="Client" class="img-fluid" loading="lazy">
                  <div class="rating">
                    <i class="bi bi-star-fill"></i>
                    <i class="bi bi-star-fill"></i>
                    <i class="bi bi-star-fill"></i>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item" data-aos="zoom-in" data-aos-delay="400">
                <div class="testimonial-header">
                  <img src="{{ asset('marketing/assets/img/person/person-f-6.webp') }}" alt="Client" class="img-fluid" loading="lazy">
                  <div class="rating">
                    <i class="bi bi-star-fill"></i>
                    <i class="bi bi-star-fill"></i>
                    <i class="bi bi-star-fill"></i>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item" data-aos="zoom-in" data-aos-delay="500">
                <div class="testimonial-header">
                  <img src="{{ asset('marketing/assets/img/person/person-m-12.webp') }}" alt="Client" class="img-fluid" loading="lazy">
                  <div class="rating">
                    <i class="bi bi-star-fill"></i>
                    <i class="bi bi-star-fill"></i>
                    <i class="bi bi-star-fill"></i>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item" data-aos="zoom-in" data-aos-delay="600">
                <div class="testimonial-header">
                  <img src="{{ asset('marketing/assets/img/person/person-f-10.webp') }}" alt="Client" class="img-fluid" loading="lazy">
                  <div class="rating">
                    <i class="bi bi-star-fill"></i>
                    <i class="bi bi-star-fill"></i>
                    <i class="bi bi-star-fill"></i>
        ...
        <div class="row align-items-center">
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
            <div class="avatars d-flex align-items-center">
              <img src="{{ asset('marketing/assets/img/person/person-m-2.webp') }}" alt="Avatar 1" class="rounded-circle" loading="lazy">
              <img src="{{ asset('marketing/assets/img/person/person-m-3.webp') }}" alt="Avatar 2" class="rounded-circle" loading="lazy">
              <img src="{{ asset('marketing/assets/img/person/person-f-5.webp') }}" alt="Avatar 3" class="rounded-circle" loading="lazy">
              <img src="{{ asset('marketing/assets/img/person/person-m-5.webp') }}" alt="Avatar 4" class="rounded-circle" loading="lazy">
            </div>
          </div>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="200">
            <div class="pricing-card">
              ...
              <div class="plan-cta">
                <a href="{{ route('marketing.pricing') }}" class="btn-plan">Choose Plan</a>
              </div>
            </div>
          </div><!-- End Basic Plan -->
        ...
        <div class="row gy-4 justify-content-between">
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
            <div class="faq-card">
              ...
              <a href="{{ route('marketing.contact') }}" class="btn btn-primary">Contact Us</a>
            </div>
          </div>
        </div>
        ...
        <div class="team-slider swiper init-swiper" data-aos="fade-up" data-aos-delay="300">
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="team-member">
                <div class="member-image">
                  <img src="{{ asset('marketing/assets/img/person/person-m-3.webp') }}" class="img-fluid" alt="" loading="lazy">
            ...
            <div class="swiper-slide">
              <div class="team-member">
                <div class="member-image">
                  <img src="{{ asset('marketing/assets/img/person/person-f-5.webp') }}" class="img-fluid" alt="" loading="lazy">
                  <div class="member-social">
                    <a href="#"><i class="bi bi-twitter-x"></i></a>
                    <a href="#"><i class="bi bi-facebook"></i></a>
                    <a href="#"><i class="bi bi-instagram"></i></a>
            ...
            <div class="swiper-slide">
              <div class="team-member">
                <div class="member-image">
                  <img src="{{ asset('marketing/assets/img/person/person-m-8.webp') }}" class="img-fluid" alt="" loading="lazy">
                  <div class="member-social">
                    <a href="#"><i class="bi bi-twitter-x"></i></a>
                    <a href="#"><i class="bi bi-facebook"></i></a>
                    <a href="#"><i class="bi bi-instagram"></i></a>
            ...
            <div class="swiper-slide">
              <div class="team-member">
                <div class="member-image">
                  <img src="{{ asset('marketing/assets/img/person/person-f-9.webp') }}" class="img-fluid" alt="" loading="lazy">
                  <div class="member-social">
                    <a href="#"><i class="bi bi-twitter-x"></i></a>
                    <a href="#"><i class="bi bi-facebook"></i></a>
                    <a href="#"><i class="bi bi-instagram"></i></a>
            ...
            <div class="swiper-slide">
              <div class="team-member">
                <div class="member-image">
                  <img src="{{ asset('marketing/assets/img/person/person-m-12.webp') }}" class="img-fluid" alt="" loading="lazy">
                  <div class="member-social">
                    <a href="#"><i class="bi bi-twitter-x"></i></a>
                    <a href="#"><i class="bi bi-facebook"></i></a>
                    <a href="#"><i class="bi bi-instagram"></i></a>
            ...
            <div class="swiper-slide">
              <div class="team-member">
                <div class="member-image">
                  <img src="{{ asset('marketing/assets/img/person/person-f-7.webp') }}" class="img-fluid" alt="" loading="lazy">
                  <div class="member-social">
                    <a href="#"><i class="bi bi-twitter-x"></i></a>
                    <a href="#"><i class="bi bi-facebook"></i></a>
                    <a href="#"><i class="bi bi-instagram"></i></a>
              ...
              <div class="contact-info-grid">
                <div class="info-item" data-aos="zoom-in" data-aos-delay="250">
                  ...
                  <div class="info-content">
                    ...
                    <p>{{ config('marketing.contact.address') }}</p>
                  </div>
                </div>
                ...
                <div class="info-item" data-aos="zoom-in" data-aos-delay="300">
                  ...
                  <div class="info-content">
                    <h5>Send Email</h5>
                    <p>{{ config('marketing.contact.email') }}</p>
                  </div>
                </div>
                ...
                <div class="info-item" data-aos="zoom-in" data-aos-delay="350">
                  ...
                  <div class="info-content">
                    <h5>Call Direct</h5>
                    <p>{{ config('marketing.contact.phone') }}</p>
                  </div>
                </div>
