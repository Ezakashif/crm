        ...
        'product_showcase' => [
            ...
            'items' => [
                ...
                [
                    'id' => 'superadmin',
                    'title' => 'Super Admin',
                    'benefit' => 'Operate the full multi-tenant platform with tools built for platform owners.',
                    'icon' => 'crown',
                    'image' => null,
                ],
                [
                    'id' => 'kanban',
                    'title' => 'Kanban board',
                    'benefit' => 'Drag deals and work across stages so pipeline status is obvious at a glance.',
                    'icon' => 'kanban',
                    'image' => null,
                ],
                [
                ...
                [
                    ...
                    'benefit' => 'Manage workspace settings, users, and company context from one admin area.',
                    'icon' => 'building',
                    'image' => null,
                ],
            ],
